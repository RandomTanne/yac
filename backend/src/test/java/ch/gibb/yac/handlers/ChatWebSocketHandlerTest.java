...
public class ChatWebSocketHandlerTest {
    ...
    void shouldThrowExceptionWhenRequestingChatUserNotConnected() {
        assertThrows(UserNotConnectedException.class, () -> handler.requestChat("Test Request Username", "Test Target Username"));
    }

    @Test
    void shouldThrowExceptionWhenAcceptingChatNotRequested() {
        assertThrows(ChatNotRequestedException.class, () -> handler.acceptChat("Test Request Username", "Test Target Username"));
    }

    @Test
    void shouldThrowExceptionWhenSendingChatNotOngoing() {
        assertThrows(NoOngoingChatException.class, () -> handler.sendChat("Test Request Username", "Test Target Username", "Test Message"));
    }
}
