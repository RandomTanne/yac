...
public class ChatController {
    ...
    public ResponseEntity<String> requestChat(
            ...
            @RequestBody @Valid TargetUsernameDTO targetUsernameDTO) {
        try {
            handler.requestChat(user.getUsername(), targetUsernameDTO.targetUsername());
            return ResponseEntity.ok(
                    "You have successfully requested a chat with "
            ...
            return new ResponseEntity<>(
                    "You cannot start a chat with yourself", HttpStatus.BAD_REQUEST);
        }
    }
    ...
    public ResponseEntity<String> acceptChat(
        ...
        try {
            ...
            return ResponseEntity.ok(
                    "You have successfully accepted a chat with "
                            + targetUsernameDTO.targetUsername());
        } catch (IOException e) {
            return new ResponseEntity<>(
            ...
            return new ResponseEntity<>(
                    "The user "
                            + targetUsernameDTO.targetUsername()
                            + " has not requested a chat with you",
                    HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<String> sendChat(
        ...
        try {
            ...
            return new ResponseEntity<>(
                    "The user " + message.targetUsername() + " is not connected",
                    HttpStatus.NOT_FOUND);
