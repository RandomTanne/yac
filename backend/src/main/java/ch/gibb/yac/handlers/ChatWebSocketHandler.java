...
public class ChatWebSocketHandler extends TextWebSocketHandler {
    ...
    public void requestChat(String requestUsername, String targetUsername)
        ...
        if (requestUsername.equals(targetUsername)) {
            throw new CannotStartChatWithYourselfException(
                    "The user cannot start a chat with himself");
        }
    ...
    public void acceptChat(String requestUsername, String targetUsername)
        ...
        String acceptMessage =
                objectMapper.writeValueAsString(
                        new WebSocketResponseDTO("accept", requestUsername));
    ...
    public void cancelAllChats(String requestUsername)
            throws IOException, UserNotConnectedException {
